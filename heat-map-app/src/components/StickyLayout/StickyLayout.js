    ...
    return (
      <div>
        ...
        <Container text style={{ marginTop: '2em' }}>
          <Header as='h1'>Welcome to the Gun Violence HeatMap App!</Header>
          <p>
        ...
        >
          ...
          >
            <Container text>
              <Menu.Item header>Gun Violence HeatMap App</Menu.Item>
              <Menu.Item as='a'>HeatMap</Menu.Item>
              <Menu.Item as='a'>Other Data Visuals</Menu.Item>
              <Menu.Item as='a'>Articles</Menu.Item>

              <Menu.Menu position='right'>
                <Dropdown text='Search HeatMap By' pointing className='link item'>
                  <Dropdown.Menu>
                    <Dropdown.Item>State</Dropdown.Item>
                    <Dropdown.Item>City</Dropdown.Item>
                    <Dropdown.Item>County</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </Menu.Menu>
            </Container>
